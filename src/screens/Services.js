      ...
      <div className="container">
        ...
        <div className="row g-4">
          ...
          <div className="col-md-4">
            <div className="service-card h-100 text-start">
              <div className="mb-3 text-start d-flex align-items-center">
                <div className="icon-circle blue d-flex align-items-center justify-content-center ms-3">
          ...
          <div className="col-md-4">
            <div className="service-card h-100 text-start">
              <div className="mb-3 text-start d-flex align-items-center">
                <div className="icon-circle purple d-flex align-items-center justify-content-center ms-3">
          ...
          <div className="col-md-4">
            <div className="service-card h-100 text-start">
              <div className="mb-3 text-start d-flex align-items-center">
                <div className="icon-circle green d-flex align-items-center justify-content-center ms-3">
          ...
          <div className="col-md-4">
            <div className="service-card h-100 text-start">
              <div className="mb-3 text-start d-flex align-items-center">
                <div className="icon-circle bg-warning d-flex align-items-center justify-content-center ms-3">
          ...
          <div className="col-md-4">
            <div className="service-card h-100 text-start">
              <div className="mb-3 text-start d-flex align-items-center">
                <div className="icon-circle bg-danger d-flex align-items-center justify-content-center ms-3">
          ...
          <div className="col-md-4">
            <div className="service-card h-100 text-start">
              <div className="mb-3 text-start d-flex align-items-center">
                <div className="icon-circle bg-primary d-flex align-items-center justify-content-center ms-3">
          ...
          <div className="col-md-6">
            <div className="service-card h-100 text-start shadow-lg rounded-4 p-4">
              <div className="mb-3 text-start d-flex align-items-center">
                <div className="icon-circle bg-success d-flex align-items-center justify-content-center ms-3">
